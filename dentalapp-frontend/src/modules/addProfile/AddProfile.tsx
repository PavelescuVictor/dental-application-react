...
import StyledAddProfile from './AddProfile.style';
...
const AddProfile = (): JSX.Element => {
  ...
  const handleSubmit = async (event: any) => {
    ...
    try {
      await dispatch(profileManagerAsyncThunk.addProfile(formValues)).unwrap();
      const alert = {
        alertMessage: 'Added profile successfully',
      ...
      const alert = {
        alertMessage: 'Added profile unsuccessfully',
...
export default withAccessControl(AddProfile, RouteAccessTypes.ONLY_ADMINS);
