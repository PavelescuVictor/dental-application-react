...
import { orderManagerAsyncThunk } from 'store/slices/orderManagerSlice/orderManager';
...
import StyledAddOrder from './AddOrder.style';
...
export default withAccessControl(AddOrder, RouteAccessTypes.ONLY_ADMINS);
